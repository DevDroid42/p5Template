...
declare module '....index' {
    class MediaElement extends Element {
         ...
         *   zero. Calling media.play() will restart playing
        ...
        /**
         *   Stops the audio/video from playing in a loop. It
        ...
        /**
         *   Manages the audio/video volume. Calling
        ...
        /**
         *   Manages the audio/video playback speed. Calling
         *   media.speed() returns the current speed as a
         *   number. The parameter, val, is optional. It's a
         *   number that sets the playback speed. 1 plays the
         *   media at normal speed, 0.5 plays it at half speed,
         *   2 plays it at double speed, and so on. -1 plays
         *   the media at normal speed in reverse.
         *
        ...
        /**
         *   Manages the media element's playback time. Calling
         *   media.time() returns the number of seconds the
         *   audio/video has played. Time resets to 0 when the
         *   looping media restarts. The parameter, time, is
         *   optional. It's a number that specifies the time,
         *   in seconds, to jump to when playback begins.
         ...
         *   end of its playback The function won't be called
         *   if the media is looping. The p5.MediaElement is
        ...
        /**
         *   Show the default HTMLMediaElement controls. These
         *   vary between web browser.
         */
        showControls(): void;
    ...
    class File {
        ...
        /**
         *   A string containing either the file's image data,
         *   text contents, or a parsed object in the case of
         *   JSON and p5.XML objects.
         */
        data: any;
    }
    interface p5InstanceExtensions {
         ...
         *   @return new p5.Element object.
         */
        createCapture(type?: string | TYPE | object, flipped?: object, callback?: (...args: any[]) => any): Element;
    ...
    interface Element {
        ...
        /**
         *   Applies a style to an element by adding a CSS
        ...
        /**
         *   Sets a function to call when the user drops a file
         *   on the element. The first parameter, callback, is
         *   a function to call once the file loads. The
         *   callback function should have one parameter, file,
         *   that's a p5.File object. If the user drops
         *   multiple files on the element, callback, is called
         *   once for each file.
         *
        ...
        /**
         *   Turns p5.Element into a draggable item. If an
         *   argument is given, it will drag that p5.Element
         *   instead, ie. drag a entire GUI panel (parent
         *   container) with the panel's title bar.
         *   @param [elmnt] pass another p5.Element
         *   @chainable
         */
