...
declare module '....index' {
    class Element {
         ...
         *   and so on. All elements share the methods of the
         *   p5.Element class. They're created with functions
         *   such as createCanvas() and createButton().
         *
        ...
        /**
         *   Attaches this element to a parent element. For
        ...
        /**
         *   Adds a class attribute to the element. Calling
         *   myElement.class() without an argument returns a
         ...
         *   disables the function. Note: Some mobile browsers
         *   may also trigger this event when the element
         ...
         *   th element. The callback function, fxn, is passed
         ...
         *   function. Note: Some mobile browsers may also
         *   trigger this event when the element receives a
         *   quick tap.
         *   @param fxn function to call when the mouse is
         *   pressed over the element. false disables the
         *   function.
         ...
         *   function. Note: Touch functions only work on
         *   mobile devices.
         ...
         *   and moves their finger. Calling
         ...
         *   disables the function. Note: Touch functions only
         ...
         *   myElement.dragLeave(false) disables the function.
         *   @param fxn function to call when the file is
        ...
        /**
         *   Underlying HTMLElement object. Its properties and
